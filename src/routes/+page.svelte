    ...
    <div class="flex md:flex-row flex-col gap-8">
        <div class="w-full lg:w-2/3">
            ...
            <div class="pt-6 text-justify w-full lg:w-[80%]">
                Wir freuen uns auf Ihren Besuch in unserer modern ausgestatteten hausärztlichen Praxis. Unabhängig von
                der Behandlung versuchen wir unsere Patienten umfassend zu informieren, denn nur gut informierte
                Patienten sind in der Lage richtige Entscheidungen zu treffen. Ihre Gesundheit steht bei uns im
                Mittelpunkt. Uns ist es ein großes Anliegen, dass Sie sich in unserer hausärztlichen Praxis wohl und gut
                aufgehoben fühlen. Für Rückmeldungen sind wir stets dankbar.
            </div>
