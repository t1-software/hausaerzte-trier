<div class="legal-page">
    ...
    <p
        ...
        personenbezogenen Daten (nachfolgend kurz „Daten“) umgehen, welche Informationen über die Besucher unserer
        Website wir erfassen und auswerten, ob und wie wir diese Informationen nutzen, weitergeben oder anderweitig
        verarbeiten.
    </p>
    <p
        >Diese Datenschutzerklärung gilt für Ihren Besuch unserer Website (nachfolgend bezeichnet als „Onlineangebot“).
        Im Hinblick auf die verwendeten Begrifflichkeiten, wie z. B. „Verarbeitung“ oder „Verantwortlicher“ verweisen
    ...
    >
    <p
        ><strong>Hausarztpraxis Thiemo Stiemert</strong><br />Facharzt für Allgemeinmedizin<br />Gilbertstraße 59 |
    ...
    <p
        ...
        natürliche Person (im Folgenden „betroffene Person“) beziehen; als identifizierbar wird eine natürliche Person angesehen,
    ...
    >
    <p
        ><strong>„Verarbeitung“</strong> ist jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführte Vorgang oder
    ...
    >
    <p
        >Als <strong>„Verantwortlicher“</strong> wird die natürliche oder juristische Person, Behörde, Einrichtung oder andere
        Stelle, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten
    ...
    <p
        ...
        die Rechtsgrundlage in der Datenschutzerklärung nicht genannt wird, gilt Folgendes: Die Rechtsgrundlage für die
    ...
    <p
        ...
        Interessen (z. B. beim Einsatz von Beauftragten, Webhostern, usw.).</p
    >
    <p
    ...
    <p
        ...
        Garantien, wie der Beachtung offiziell anerkannter spezieller vertraglicher Verpflichtungen (so genannte
    ...
    <p
        ...
        weil sie für andere und gesetzlich zulässige Zwecke erforderlich sind, wird deren Verarbeitung eingeschränkt. D.
        h. die Daten werden gesperrt und nicht für andere Zwecke verarbeitet. Das gilt z. B. für Daten, die aus handels-
    ...
    <p
        ...
        für Besteuerung relevanter Unterlagen, usw.) und 6 Jahre gemäß § 257 Abs. 1 Nr. 2 und 3, Abs. 4 HGB
        (Handelsbriefe).</p
    >
    ...
    <p
        ><span class="ts-muster-content"
            ...
            (z. B., Name, Adresse, usw.), als auch die Kontaktdaten (z. B., E-Mailadresse, Telefon, usw.), die
            Vertragsdaten (z. B., in Anspruch genommene Leistungen, erworbene Produkte, Kosten, Namen von
            Kontaktpersonen) und Zahlungsdaten (z. B., Bankverbindung, Zahlungshistorie, usw.).</span
        ></p
    >
    <p
        >In Rahmen unserer Leistungen, können wir ferner besondere Kategorien von Daten gem. Art. 9 Abs. 1 DSGVO, hier
        insbesondere Angaben zur Gesundheit der Patienten, ggf. mit Bezug zu deren Sexualleben oder der sexuellen
        Orientierung, verarbeiten. Hierzu holen wir, sofern erforderlich, gem. Art. 6 Abs. 1 lit. a., Art. 7, Art. 9
        Abs. 2 lit. a. DSGVO eine ausdrückliche Einwilligung der Patienten ein und verarbeiten die besonderen Kategorien
        von Daten ansonsten zu Zwecken der Gesundheitsvorsorge auf Grundlage des Art. 9 Abs. 2 lit h. DSGVO, § 22 Abs. 1
        Nr. 1 b. BDSG.</p
    >
    <p
        >Sofern für die Vertragserfüllung oder gesetzlich erforderlich, offenbaren oder übermitteln wir die Daten der
        Patienten im Rahmen der Kommunikation mit medizinischen Fachkräften, an der Vertragserfüllung
        ...
        Patienten an einer effizienten und kostengünstigen Gesundheitsversorgung als berechtigtes Interesse gem. Art. 6
        Abs. 1 lit f. DSGVO dient oder gem. Art. 6 Abs. 1 lit d. DSGVO notwendig ist. um lebenswichtige Interessen der
        Patienten oder einer anderen natürlichen Person zu schützen oder im Rahmen einer Einwilligung gem. Art. 6 Abs. 1
        lit. a., Art. 7 DSGVO.</p
    >
    <p
        >Die Löschung der Daten erfolgt, wenn die Daten zur Erfüllung vertraglicher oder gesetzlicher Fürsorgepflichten
        sowie Umgang mit etwaigen Gewährleistungs- und vergleichbaren Pflichten nicht mehr erforderlich ist, wobei die
    ...
    <p
        ><span class="ts-muster-content"
            ...
            Finanzbuchhaltung und Befolgung der gesetzlichen Pflichten, wie z. B. der Archivierung. Hierbei verarbeiten
            wir dieselben Daten, die wir im Rahmen der Erbringung unserer vertraglichen Leistungen verarbeiten. Die
            Verarbeitungsgrundlagen sind Art. 6 Abs. 1 lit. c. DSGVO, Art. 6 Abs. 1 lit. f. DSGVO. Von der Verarbeitung
            sind Kunden, Interessenten, Geschäftspartner und Websitebesucher betroffen. Der Zweck und unser Interesse an
            der Verarbeitung liegt in der Administration, Finanzbuchhaltung, Büroorganisation, Archivierung von Daten,
            also Aufgaben die der Aufrechterhaltung unserer Geschäftstätigkeiten, Wahrnehmung unserer Aufgaben und
            Erbringung unserer Leistungen dienen. Die Löschung der Daten im Hinblick auf vertragliche Leistungen und die
            vertragliche Kommunikation entspricht den, bei diesen Verarbeitungstätigkeiten genannten Angaben.</span
        ></p
    >
    <p
        >Wir offenbaren oder übermitteln hierbei Daten an die Finanzverwaltung, Berater, wie z. B., Steuerberater oder
        Wirtschaftsprüfer sowie weitere Gebührenstellen und Zahlungsdienstleister.</p
    >
    <p
    ...
    <p
        ><span class="ts-muster-content"
            ...
            Betriebssystem des Nutzers, Referrer URL (die zuvor besuchte Seite), IP-Adresse und der anfragende Provider.</span
        ></p
    >
    <p
    ...
    <p
        ><span class="ts-muster-content"
            ...
            lit. f. DSGVO) Inhalts- oder Serviceangebote von Drittanbietern ein, um deren Inhalte und Services, wie z.
            B. Videos oder Schriftarten einzubinden (nachfolgend einheitlich bezeichnet als “Inhalte”).</span
        ></p
    >
    <p
    ...
    <p
        ...
        „Inhalte”). Die Einbindung setzt immer voraus, dass die Drittanbieter dieser Inhalte die IP-Adresse der Nutzer
        ...
        Besucherverkehr auf den Seiten dieser Webseite, ausgewertet werden. Die pseudonymen Informationen können ferner
        in Cookies auf dem Gerät der Nutzer gespeichert werden und unter anderem technische Informationen zum Browser
        und zum Betriebssystem, zu verweisenden Webseiten, zur Besuchszeit sowie weitere Angaben zur Nutzung unseres
        Onlineangebotes enthalten als auch mit solchen Informationen aus anderen Quellen verbunden werden. Hinweise zu
        Rechtsgrundlagen: Sofern wir die Nutzer um deren Einwilligung in den Einsatz der Drittanbieter bitten, ist die
        Rechtsgrundlage der Verarbeitung von Daten die Einwilligung. Ansonsten werden die Daten der Nutzer auf Grundlage
        ...
        Cookies in dieser Datenschutzerklärung hinweisen. Verarbeitete Datenarten: Nutzungsdaten (z.B. besuchte
        Webseiten, Interesse an Inhalten, Zugriffszeiten), Meta-/Kommunikationsdaten (z.B. Geräte-Informationen,
        IP-Adressen). Betroffene Personen: Nutzer (z.B. Webseitenbesucher, Nutzer von Onlinediensten). Zwecke der
        Verarbeitung: Bereitstellung unseres Onlineangebotes und Nutzerfreundlichkeit, Vertragliche Leistungen und
