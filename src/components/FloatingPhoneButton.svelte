...
<a href="tel:{CONTACT_INFO.PHONE}" class="floating-phone-button" aria-label="Praxis anrufen: {CONTACT_INFO.PHONE}">
...
<style>
    .floating-phone-button {
        ...
        box-shadow: 0 10px 20px -6px rgb(14 31 24 / 0.5);
        transition:
    ...
    /* Desktop already shows the number in the navbar and hero */
